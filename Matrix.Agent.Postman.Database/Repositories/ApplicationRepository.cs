...
namespace Matrix.Agent.Postman.Database
{
    public class ApplicationRepository : Repository, IApplicationRepository
    {
        ...
        public async Task<List<Application>> GetApplications()
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.GetApplications");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.GetApplications");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.GetApplications");
        ...
        public async Task<Application> GetApplicationById(Guid id)
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.GetApplicationById");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.GetApplicationById");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.GetApplicationById");
        ...
        public async Task<bool> ContainsApplication(Guid id)
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.ContainsApplication");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.ContainsApplication");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.ContainsApplication");
        ...
        public async Task<bool> CreateApplication(Guid id, string name, string description)
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.CreateApplication");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.CreateApplication");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.CreateApplication");
        ...
        public async Task<bool> UpdateApplication(Guid id, string name, string description)
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.UpdateApplication");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.UpdateApplication");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.UpdateApplication");
        ...
        public async Task<bool> DeleteApplication(Guid id)
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Postman.Database.ApplicationRepository.DeleteApplication");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Postman.Database.ApplicationRepository.DeleteApplication");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Postman.Database.ApplicationRepository.DeleteApplication");

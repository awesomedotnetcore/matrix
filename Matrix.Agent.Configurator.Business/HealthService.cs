...
namespace Matrix.Agent.Configurator.Business
{
    public class HealthService : Service, IHealthService
    {
        ...
        public async Task<HealthTestResult> Test()
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Configurator.Business.HealthService.Test");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Configurator.Business.HealthService.Test");
                Logger.Error(e);
            }

            Logger.Trace("END | Matrix.Server.Configurator.Business.HealthService.Test");

...
namespace Matrix.Agent.Configurator.Database
{
    public class HealthRepository : Repository, IHealthRepository
    {
        ...
        public async Task<HealthTestResult> Test()
        {
            ...
            Logger.Trace("BEGIN | Matrix.Server.Configurator.Database.HealthRepository.Test");
            ...
            {
                Logger.Trace("ERROR | Matrix.Server.Configurator.Database.HealthRepository.Test");
                Logger.Error(e);
            ...
            Logger.Trace("END | Matrix.Server.Configurator.Database.ApplicationRepository.Test");
